...
public class predefinedRoutineServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        Routine cardio = new Routine("Head to Toe Cardio",
                "Do each move for 45 seconds and rest after each move for 10 seconds.", "Cardio", cardioMoves, 3);
        ...
        Routine abs = new Routine("Extreme Ab Toner",
                "Do each move for 1 minute and rest for 15 seconds after each move.", "Abs", abMoves, 3);
        ...
        Routine backShoulder = new Routine("Ultimate Back/Shoulder Workout",
                "Do each move for 45 seconds and rest for 15 seconds between each move.", "Back/Shoulder", backShoulderMoves, 5);
